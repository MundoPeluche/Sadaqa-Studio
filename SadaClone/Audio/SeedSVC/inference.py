...
def load_models(args):
    ...
    if not args.f0_condition:
        ...
        if args.checkpoint is None:
            dit_checkpoint_path = "C:/SeedVCModels/models--Plachta--Seed-VC/DiT_seed_v2_uvit_whisper_base_f0_44k_bigvgan_pruned_ft_ema_v2.pth"
            dit_config_path = "C:/SeedVCTest/configs/presets/config_dit_mel_seed_uvit_whisper_base_f0_44k.yml"
        else:
            dit_checkpoint_path = args.checkpoint
            dit_config_path = args.config
        # f0 extractor
        ...
        model_path = "C:/SeedVCModels/models--lj1995--VoiceConversionWebUI/rmvpe.pt"
    ...
    campplus_ckpt_path = r"C:\SeedVCModels\models--funasr--campplus\campplus_cn_common.bin"
    ...
    if vocoder_type == 'bigvgan':
        ...
        bigvgan_name = r"C:\SeedVCModels\models--nvidia--bigvgan_v2_44khz_128band_512x"
    ...
    if speech_tokenizer_type == 'whisper':
        ...
        whisper_name = "C:/SeedVCModels/models--openai--whisper-small"
        whisper_model = WhisperModel.from_pretrained(whisper_name, torch_dtype=torch.float32, local_files_only=True).to(device)
